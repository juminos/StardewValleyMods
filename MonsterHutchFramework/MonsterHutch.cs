            ...
            if (e.NameWithoutLocale.IsEquivalentTo("Data/Buildings"))
            {
                e.Edit(asset =>
                {
                    ...
                    var monsterHutch = new BuildingData
                    {
                        ...
                        DrawShadow = true,
                        UpgradeSignTile = new Microsoft.Xna.Framework.Vector2((float)3.5, 4),
                    ...
                    var expandedHutch = new BuildingData
                    {
                        ...
                        Texture = ModEntry.Mod.MonsterHutchExteriorPath,
                        DrawShadow = true,
                        UpgradeSignTile = new Microsoft.Xna.Framework.Vector2((float)3.5, 3),
                        UpgradeSignHeight = 12.0f,
                        Size = new Microsoft.Xna.Framework.Point(11, 6),
                        FadeWhenBehind = true,
                        Builder = null,
