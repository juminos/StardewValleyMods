...
using static MonstersTheFramework.IMonstersTheFrameworkAPI;
...
public class MonsterType : IMonsterType
{
    public class StateData : ICloneable
    {
        ...
        public class EventData : ICloneable
        {
            ...
            public object Clone()
            {
                ...
                if (Actions != null)
                {
                    ...
                    ModEntry.SMonitor.Log($"actions is null", LogLevel.Warn);
        ...
        public object Clone()
        {
            ...
            if (Events == null)
            {
                ModEntry.SMonitor.Log("events is null", LogLevel.Trace);
            }
