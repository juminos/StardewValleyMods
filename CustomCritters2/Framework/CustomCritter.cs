...
namespace CustomCritters2.Framework
{
    internal class CustomCritter : Critter
    {
        ...
        {
            return ModEntry.Instance.Helper.ModContent.Load<Texture2D>($"Critters/{id}/critter.png");
        }
        ...
        public override bool update(GameTime time, GameLocation environment)
        {
            ...
            if (this.Data.Behavior != null)
            {
                switch (this.Data.Behavior.Type)
                {
                            ...
                            else
                            {
                                if (this.NeedTarget)
                                {
                                    ...
                                    switch (pt.Type)
                                    {
                                        ...
                                        default:
                                            ModEntry.SMonitor.Log("Bad patrol point type: " + pt.Type, LogLevel.Warn);
                                            break;
                                    }
                    ...
                    default:
                        ModEntry.SMonitor.Log("Bad custom critter behavior: " + this.Data.Behavior.Type, LogLevel.Warn);
                        break;
                }
            }
