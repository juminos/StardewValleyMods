...
namespace CustomCritters2
{
        ...
        public interface IBugNetApi
        {
            ...
            *********/
            ...
            void RegisterCritter(IManifest manifest, string critterId, Texture2D texture, string textureName, Rectangle textureArea, string defaultCritterName, Dictionary<string, string> translatedCritterNames, Func<int, int, Critter> makeCritter, Func<Critter, bool> isThisCritter);
        }
}