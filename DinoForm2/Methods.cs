    ...
    public partial class ModEntry
    {
        ...
        public static void PlayTransform()
        {
            ...
            if (Game1.random.NextDouble() < 0.5)
                sprites.Add(new TemporaryAnimatedSprite(362, (float)Game1.random.Next(30, 90), 6, 1, new Vector2(Game1.player.Tile.X * 64f, Game1.player.Tile.Y * 64f), false, Game1.random.NextDouble() < 0.5));
            else
                sprites.Add(new TemporaryAnimatedSprite(362, (float)Game1.random.Next(30, 90), 6, 1, new Vector2(Game1.player.Tile.X * 64f, Game1.player.Tile.Y * 64f), false, Game1.random.NextDouble() < 0.5));
            ((Multiplayer)AccessTools.Field(typeof(Game1), "multiplayer").GetValue(null)).broadcastSprites(Game1.player.currentLocation, sprites.ToArray());
